...
import com.zhijia.ui.GetDeviceId;
import com.zhijia.ui.R;
import com.zhijia.ui.frame.MoreFrame;
import com.zhijia.ui.frame.MyFrame;
import com.zhijia.ui.frame.SearchFrame;
...
public class MainActivity extends FrameActivity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		Log.d(Tag,"city_ID:" + Global.NOW_CITY);
			if (Global.NOW_CITY.equalsIgnoreCase("") || Global.NOW_CITY_ID.equalsIgnoreCase("")) {
//				Intent intent = new Intent(MainActivity.this,SelectCityActivity.class);
//				startActivityForResult(intent, 100);
				IntentUtil.startActivityForResult(MainActivity.this, SelectCityActivity.class, requestCode, null);
			} else {
