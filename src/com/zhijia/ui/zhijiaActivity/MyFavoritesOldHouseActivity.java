 ...
 * 我收藏的二手房列表
 */
public class MyFavoritesOldHouseActivity extends MyBaseHouseActivity<MyFavoritesOldHouseJsonModel> {

    private final String FAVORITES_OLD_HOUSE_URL = Global.API_WEB_URL+"/member/collection" ;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        //设置总数的
        setCountStr(R.string.total_favorites_old_house_count);
        setCountId(R.id.total_count_desc);
        setWeek(new WeakReference<Activity>(MyFavoritesOldHouseActivity.this));
        ListView listView = (ListView) findViewById(R.id.my_common_house_list);
        Map<String, String> tempMap = new HashMap<String, String>();
        tempMap.put("cityid", Global.NOW_CITY_ID);
        tempMap.put("identity","1") ;
        //初始化列表，布局 和条件
        initView(listView, R.layout.my_favorites_old_house_list_item, tempMap);
        Map<Integer, String> titleMap = new HashMap<Integer, String>();
        titleMap.put(R.id.title, getString(R.string.my_favorites_old_house));
        setTitle(titleMap, R.id.back);
        setLogin(MyFavoritesOldHouseActivity.this);
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Intent intent  = new Intent(MyFavoritesOldHouseActivity.this, OldHouseDetailsActivity.class) ;
    ...
    public JsonResult<List<MyFavoritesOldHouseJsonModel>> getListDataByNetWork(Map<String, String> paramMap) {
        ...
        Optional<JsonResult<List<MyFavoritesOldHouseJsonModel>>> optional = httpClientUtils.getUnsignedListByData(FAVORITES_OLD_HOUSE_URL, paramMap, MyFavoritesOldHouseJsonModel.class);
