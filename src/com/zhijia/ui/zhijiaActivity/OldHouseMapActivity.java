 ...
 * 二手房地图页
 */
public class OldHouseMapActivity extends BaseHouseConditionActivity implements IListDataNetWork<HouseMapListJsonModel>, AbsListView.OnScrollListener{
    ...
    private HouseCountOverlay myOverlay = null;
...
//        baseModel.setTexts(texts);
        ...
        findViewById(R.id.new_house_list).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent oldHouseIntent = new Intent(OldHouseMapActivity.this.getApplicationContext(), OldHouseActivity.class);
                startActivity(oldHouseIntent);
                OldHouseMapActivity.this.finish();
            }
        });
        //用户主动请求定位到当前位置
    ...
    private void setCondition(){
        ...
        this.setCommonHouseTitle(R.id.house_top_app_gps, R.string.old_house_title);
        this.bindEventArea(areaIds, relativeId, ListType.OLD);
    ...
    private void initOverlay() {
        PopupClickListener popListener = new PopupClickListener() {
            ...
            public void onClickedPopup(int index) {
                Intent oldHouseDetails = new Intent(getApplicationContext(), OldHouseDetailsActivity.class);
                oldHouseDetails.putExtra("hid", currentHid);
                startActivity(oldHouseDetails);
            }
        };

        //创建自定义overlay
        myOverlay = new HouseCountOverlay(getResources().getDrawable(R.drawable.map_location_icons), mMapView, getApplicationContext(), popListener);
    ...
    public void startListTask(BaseModel baseModel) {
        OldHouseMapAsyncTask oldHouseMapAsyncTask = new OldHouseMapAsyncTask();
        oldHouseMapAsyncTask.execute(baseModel);
    }
    ...
    public void setNetWorkErrorValue(BaseModel baseModel) {
        ...
        ItemAdapter itemAdapter = new ItemAdapter(OldHouseMapActivity.this, baseModel.getItemLayoutInflaterId(), baseModel.getListData());
        setItemAdapter(itemAdapter);
        listView.setAdapter(itemAdapter);
        Toast.makeText(OldHouseMapActivity.this, Global.ERROR_NET_WORK, Toast.LENGTH_SHORT).show();
    }
    ...
    public void loadData(){
        ...
        if (nowPage < totalPage) {
            ...
            CommunityOldHousePageAsyncTask pageAsyncTask = new CommunityOldHousePageAsyncTask();
    ...
    public void setRoomByNetWork(final BaseModel baseModel,final int index){
        ...
        if (conditionJsonModel.getRoom() != null) {
            ...
            dialog = new AlertDialog.Builder(OldHouseMapActivity.this).setItems(params.toArray(paramStr), new DialogInterface.OnClickListener() {
                @Override
                public void onClick(DialogInterface dialog, int which) {
                    ...
                    CommunityOldHouseAsyncTask task = new CommunityOldHouseAsyncTask(index);
    ...
    public class OldHouseMapAsyncTask extends AsyncTask<BaseModel, Void, JsonResult<List<HouseMapListJsonModel>>> {
        ...
        protected void onPostExecute(JsonResult<List<HouseMapListJsonModel>> jsonResult) {
            if (jsonResult != null && jsonResult.isStatus()) {
                ...
                Log.d("OldHouseMapAsyncTask == mapListJsonModels", mapListJsonModels.size() + "");
                ...
                setNetWorkErrorValue(getBaseModel());
            }
        }
    }
     ...
     * 楼房坐标浮动层
     */
    public class HouseCountOverlay extends BaiduMapUtil.AbstractOverlay {
        public HouseCountOverlay(Drawable defaultMarker, MapView mapView, Context context, PopupClickListener popListener) {
        ...
        public boolean onTap(int index) {
            ...
            listView.setOnScrollListener(OldHouseMapActivity.this);
            listView.setOnItemClickListener(listener);
            CommunityOldHouseAsyncTask communityRentHouseAsyncTask = new CommunityOldHouseAsyncTask(index);
    ...
    private class MyMKMapViewListener implements MKMapViewListener {
        ...
        public void onClickMapPoi(MapPoi mapPoiInfo) {
            ...
            if (mapPoiInfo != null) {
                ...
                Toast.makeText(OldHouseMapActivity.this, title, Toast.LENGTH_SHORT).show();
    ...
    public class CommunityOldHousePageAsyncTask extends AsyncTask<BaseModel, Void, JsonResult<List<OldHouseJsonModel>>> {
    ...
    public class CommunityOldHouseAsyncTask extends AsyncTask<BaseModel, Void, JsonResult<List<OldHouseJsonModel>>> {

        private int index;

        private BaseModel baseModel;

        public CommunityOldHouseAsyncTask(int index) {
            this.index = index;
        }
        ...
        protected void onPostExecute(JsonResult<List<OldHouseJsonModel>> jsonResult) {
            ...
            itemAdapter = new ItemAdapter(OldHouseMapActivity.this, R.layout.adapter_house_item_two, listItems);
            listView.setAdapter(itemAdapter);

            // 创建PopupWindow实例
            popupWindow = new PopupWindow(popupWindowView, ViewGroup.LayoutParams.MATCH_PARENT, ScreenUtil.getScreenHeightPixels(OldHouseMapActivity.this) * 2 / 3, true);
